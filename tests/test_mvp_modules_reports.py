...
from portwise.intelligence.cve_placeholder import EpssProvider, KevProvider, NvdProvider, enrich_services_with_cves
...
def test_cve_enrichment_findings_with_mocked_providers(tmp_path: Path, monkeypatch) -> None:
    monkeypatch.setattr(NvdProvider, "enrich", lambda self, service: type("E", (), {"cves": [{"id": "CVE-2099-0002", "cvss": 7.5, "matched_cpe": "cpe:/a:test:test:1", "references": []}], "provider_notes": []})())
