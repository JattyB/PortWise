...
_PLAINTEXT_PORTS: dict[int, tuple[str, Severity, str, bool]] = {
    ...
    23:   ("Telnet", Severity.MEDIUM, "credentials, keystrokes and session data", False),
    ...
    512:  ("rexec",  Severity.MEDIUM, "credentials and command output (legacy r-service)", False),
    513:  ("rlogin", Severity.MEDIUM, "credentials and session data (legacy r-service)", False),
    514:  ("rsh",    Severity.MEDIUM, "commands and output with host-based trust (legacy r-service)", False),
